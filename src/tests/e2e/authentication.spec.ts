...
test.describe('Authentication Flow', () => {
  ...
  test('should allow authenticated users to access admin routes', async ({ page }) => {
  ...
  test('should prevent access to admin routes from public site', async ({ page }) => {
    await page.goto('/')
  ...
  test('should remember login state in localStorage', async ({ page }) => {
    ...
    const sessionData = await page.evaluate(() => localStorage.getItem('next-auth.session-token'))
