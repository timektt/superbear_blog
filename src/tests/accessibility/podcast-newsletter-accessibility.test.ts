...
test.describe('Podcast and Newsletter Accessibility', () => {
  ...
  test('podcast listing page meets accessibility standards', async ({ page }) => {
  ...
  test('podcast detail page meets accessibility standards', async ({ page }) => {
  ...
  test('newsletter archive page meets accessibility standards', async ({ page }) => {
  ...
  test('newsletter issue page meets accessibility standards', async ({ page }) => {
  ...
  test('podcast cards have proper semantic structure', async ({ page }) => {
    ...
    const podcastTitle = page.getByRole('heading', { name: 'The Future of AI Development' });
    await expect(podcastTitle).toBeVisible();

    // Check that links have descriptive text
    const podcastLink = page.getByRole('link', { name: /The Future of AI Development/ });
  ...
  test('keyboard navigation works throughout podcast pages', async ({ page }) => {
    await page.goto('/podcasts');
  ...
  test('screen reader announcements work correctly', async ({ page }) => {
    ...
    await page.getByRole('link', { name: /The Future of AI Development/ }).click();
