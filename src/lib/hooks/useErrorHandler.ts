...
import { AppError, AppErrorHandler, ErrorHandlerOptions } from '@/lib/error-handling';
import { useToast } from '@/lib/hooks/useToast';

export interface UseErrorHandlerReturn {
  handleError: (error: unknown, options?: ErrorHandlerOptions) => AppError;
  handleAsync: <T>(promise: Promise<T>, options?: ErrorHandlerOptions) => Promise<[T | null, AppError | null]>;
