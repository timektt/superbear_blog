...
export function useAnalytics() {
  ...
  const trackNewsletterView = useCallback((variant: string) => {
  ...
  const trackNewsletterSubmit = useCallback((variant: string) => {
  ...
  const trackNewsletterSuccess = useCallback((variant: string) => {
  ...
  const trackNewsletterError = useCallback((variant: string, errorCode: string) => {
