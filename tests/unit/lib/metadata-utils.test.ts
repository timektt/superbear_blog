import { generateArticleMetadata, generateSiteMetadata } from '@/lib/metadata-utils'
  ...
  describe('generateArticleMetadata', () => {
    ...
    it('should generate complete metadata for article with image', () => {
      ...
      expect(metadata).toEqual({
        ...
        keywords: 'React, Testing, Development, tech news, AI, development tools',
    ...
    it('should use default image when article has no image', () => {
      ...
      expect(metadata.twitter.images).toEqual(['https://superbear.blog/og-default.svg'])
    })
    ...
    it('should handle article without summary', () => {
      ...
      expect(metadata.description).toBe('Read the latest tech news and insights on SuperBear Blog')
      expect(metadata.openGraph.description).toBe('Read the latest tech news and insights on SuperBear Blog')
      expect(metadata.twitter.description).toBe('Read the latest tech news and insights on SuperBear Blog')
    })
    ...
    it('should handle article without tags', () => {
      ...
      expect(metadata.keywords).toBe('Development, tech news, AI, development tools')
  ...
  describe('generateSiteMetadata', () => {
    it('should generate default site metadata', () => {
      ...
      expect(metadata).toEqual({
        ...
        description: 'Curated tech news, AI insights, and development tools for developers, AI builders, and tech entrepreneurs.',
        keywords: 'tech news, AI, development tools, startup news, programming, software development',
