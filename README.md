...
<div align="center">
  ...
  **🚀 Production-Ready Tech News & Content Management System**
  ...
  [![Next.js](https://img.shields.io/badge/Next.js-15.4.5-black?logo=next.js&logoColor=white)](https://nextjs.org/)
  ...
  [![Testing](https://img.shields.io/badge/Testing-Jest%20%2B%20Playwright-c21325?logo=jest&logoColor=white)](https://jestjs.io/)
...
erDiagram
    ...
    Article ||--o{ ArticleView : tracked_by
    Article ||--o{ Reaction : receives
    Article ||--o{ Bookmark : bookmarked_by
    
    %% User & Auth Models
    AdminUser ||--o{ Article : creates
    AdminUser ||--o{ PodcastEpisode : creates
    AdminUser ||--o{ NewsletterIssue : creates
    
    %% Newsletter & Campaign System
    Newsletter ||--o{ CampaignDelivery : receives
    NewsletterCampaign ||--o{ CampaignDelivery : sends
    NewsletterCampaign }o--|| EmailTemplate : uses
    Newsletter ||--o{ NewsletterEvent : generates
    Newsletter ||--|| NewsletterPreferences : has
    
    %% Media Management
    MediaFile ||--o{ MediaReference : referenced_by
    MediaReference }o--|| Article : references
    MediaFile ||--o{ CleanupOperation : cleaned_by
    
    %% Analytics & Performance
    Article ||--|| ArticleStats : has_stats
    Article ||--o{ ContentRecommendation : source_for
    Article ||--o{ ContentRecommendation : target_for
    ArticleView ||--o{ ArticleInteraction : contains
    
    %% Podcast System
    PodcastEpisode }o--|| Category : belongs_to
    PodcastEpisode }o--o{ Tag : tagged_with
    
    %% Newsletter Issues
    NewsletterIssue }o--|| AdminUser : created_by
```
...
```mermaid
graph TD
    A[Author Creates Article] --> B[Rich Text Editor]
    B --> C[Media Upload & Processing]
    C --> D[Content Validation]
    D --> E[Save as Draft]
    E --> F{Publish Now?}
    F -->|Yes| G[Publish Article]
    F -->|No| H[Schedule Publication]
    G --> I[Update Search Index]
    H --> J[Cron Job Processing]
    J --> G
...
graph TD
    ...
    C --> D[Recipient Filtering]
    D --> E{Send Now?}
    E -->|Yes| F[Queue for Sending]
    E -->|No| G[Schedule Campaign]
    F --> H[Batch Processing]
    G --> I[Cron Job Trigger]
    I --> F
    H --> J[Email Delivery]
    J --> K[Track Events]
...
<div align="center">
  ...
  <p>
    <a href="https://github.com/your-username/superbear-blog">
      <img src="https://img.shields.io/github/stars/your-username/superbear-blog?style=social" alt="GitHub Stars">
    </a>
    <a href="https://github.com/your-username/superbear-blog/fork">
      <img src="https://img.shields.io/github/forks/your-username/superbear-blog?style=social" alt="GitHub Forks">
    </a>
    <a href="https://twitter.com/superbear_blog">
      <img src="https://img.shields.io/twitter/follow/superbear_blog?style=social" alt="Twitter Follow">
    </a>
  </p>
  ...
  <p>
    <img src="https://img.shields.io/badge/Built%20with-Next.js-black?logo=next.js&logoColor=white" alt="Built with Next.js">
    <img src="https://img.shields.io/badge/Powered%20by-TypeScript-blue?logo=typescript&logoColor=white" alt="Powered by TypeScript">
    <img src="https://img.shields.io/badge/Styled%20with-Tailwind-38bdf8?logo=tailwind-css&logoColor=white" alt="Styled with Tailwind">
  </p>
</div>